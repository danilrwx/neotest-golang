...
function M.Adapter.is_test_file(file_path)
  ...
  local ginkgo = lib.treesitter.parse_positions(file_path, q, opts)
  local nodes = query.detect_tests(file_path)
  return ginkgo == nil and nodes ~= nil and vim.endswith(file_path, "_test.go")
end
